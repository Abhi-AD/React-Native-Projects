...
const Course = () => {
     return (
          <div>
                    ...
                    <div className="container">
                         <div className="row justify-content-center">
                              <div className="col-md-6 justify-content-center align-items-center">
                                   <p className="fs-1 lh-sm">Technical Architecture and Platform Design</p>
                                   <p className="fs-6 lh-lg">Our first priority for delivering solutions with is to create a solid foundational framework. First, we become well-acquainted with the overall vision our clients have for their projects. This, along with the active collaboration of our clients, allows us to design the platform upon which the software is to be built. The process involves defining the system&apos;s components, their interactions, and the technology stack to be used, considering factors such as scalability, security, and performance. We focus on strategic planning, decision making, and blueprinting of a technology solution, ensuring it meets business objectives and user needs while being adaptable to integrate emerging technologies as well. </p>
                              </div>
                              <div className="col-md-5 justify-content-center align-items-center">
                                   <img src="https://bajratechnologies.com/bajra_snippets/static/src/img/technical_architecture.png" alt="" className="fadeRight" />
                              </div>
                         </div>
                    </div>
               ...
               <section className=" d-flex justify-content-center align-items-center py-5" style={{ background: '#fafcff' }}>
                    <div className="container">
                         <div className="row justify-content-center">
                              <div className="col-md-5 justify-content-center align-items-center">
                                   <img src="https://bajratechnologies.com/bajra_snippets/static/src/img/user_experience.png" alt="" className="fadeLeft" />
                              </div>
                              <div className="col-md-6 justify-content-center align-items-center">
                                   <p className="fs-1 lh-sm">User Experience/ Interaction Principles and Design</p>
                                   <p className="fs-6 lh-lg">Every business-be it Bajra or any of our clients- builds software to provide solutions for its  users. At Bajra, we embrace a user-centric approach to all our technical solutions. Our designs follow a set of UI/UX design principles that prioritize accessibility and design consistency. We map out the user flow for the software from beginning to end and ensure each step of the navigation is smooth and convenient for the consumer by adopting responsive and performance-focused design strategies. Designers are subject to continuous feedback from the team and clients, allowing the creation of user-friendly and visually appealing digital experiences.</p>
                              </div>
                         </div>
                    </div>
               </section>
               ...
               <section className="container d-flex justify-content-center align-items-center py-5">
                    <div className="row justify-content-center">
                         <div className="col-md-6 justify-content-center align-items-center">
                              <p className="fs-1 lh-sm">Agile Software Prototyping and Development</p>
                              <p className="fs-6 lh-lg">All projects that we undertake follow agile prototyping and development, which is a dynamic and collaborative methodology to build and refine products through &quot;scrum&quot;. Each scrum iteration is a repetitive process where tasks are done in stages- learning from each round to make improvements. Work is divided into different sprints, which typically last 2 weeks, upon which the team works to refine and better any shortcomings from the former sprint. Our agile teams consist of cross-functional team members with diverse skills (developers, designers, testers, etc.). Agile prototyping emphasizes collaboration, frequent communication, and regular review and adaptation of the software through regular ceremonies like daily standup meetings and bi-weekly sprint reviews. This approach reduces the risk of investing extensively in a product that may not meet market needs, as it allows for early course correction based on real-world feedback.</p>
                         </div>
                         <div className="col-md-5 justify-content-center align-items-center">
                              <img src="https://bajratechnologies.com/web/image/34939/Frame%20295.png" alt="" className="fadeRight" />
                         </div>
                    </div>
               ...
               <section className=" d-flex justify-content-center align-items-center py-5" style={{ background: '#fafcff' }}>
                    <div className="container">
                         <div className="row justify-content-center">
                              <div className="col-md-5 justify-content-center align-items-center">
                                   <img src="https://bajratechnologies.com/web/image/34940/Frame%20295%20%282%29.png" alt="" className="fadeLeft" />
                              </div>
                              <div className="col-md-6 justify-content-center align-items-center">
                                   <p className="fs-1 lh-sm">Project Management Support and Services </p>
                                   <p className="fs-6 lh-lg">Our agile development strategy is effective because it stands on the shoulders of our excellent project management, meticulous project planning, resource allocation, and risk mitigation strategies. Bajra collaborates closely with clients to align project goals with business objectives through product owners. Our project management focuses on quality assurance, effective communication, and issue resolution. In addition to the fundamental services, these companies often provide specialized offerings, including scalability planning to ensure future growth, rigorous security and compliance measures, and strategic consulting to align technology solutions with broader business strategies. We offer portfolio management for overseeing multiple projects and customized reporting and dashboards to deliver tailored insights. These comprehensive services ensure that IT projects are executed efficiently, adhere to industry standards, and contribute to the long-term success of clients&apos; businesses.</p>
                              </div>
                         </div>
                    </div>
               </section>
               ...
               <section className="container d-flex justify-content-center align-items-center py-5">
                    <div className="row justify-content-center">
                         <div className="col-md-6 justify-content-center align-items-center">
                              <p className="fs-1 lh-sm">Consulting and Advisory Services</p>
                              <p className="fs-6 lh-lg">Bajra is home to diverse experts in different fields required to develop software solutions - be it general programming, front-end development, back-end development, Quality Assurance, or project management. We offer consulting and advisory services to help out with projects that align with our areas of expertise. Partial-service clients can receive our services during any part of their development. This includes a wide range of consulting and advisory services to help clients address various technology-related challenges and opportunities. We can act as consultants for organizations to manage organizational change effectively, particularly during technology implementations and transformations. This includes assessing existing IT infrastructure, recommending technology investments, and developing roadmaps for technology adoption.</p>
                         </div>
                         <div className="col-md-5 justify-content-center align-items-center">
                              <img src="https://bajratechnologies.com/web/image/34941/Frame%20295%20%283%29.png" alt="" className="fadeRight" />
                         </div>
                    </div>
               ...
               <section className="container d-flex justify-content-center align-items-center py-5">
                    <div className="row justify-content-center">
                         <div className="col-md-6 justify-content-center align-items-center">
                              <p className="fs-1 lh-sm">Continuous Delivery and Code Deployment </p>
                         ...
                         <div className="col-md-5 justify-content-center align-items-center">
                              <img src="https://bajratechnologies.com/web/image/38401/software%20%282%29.png" alt="" className="fadeRight" />
                         </div>
                    </div>
               ...
               <section className=" d-flex justify-content-center align-items-center py-5" style={{ background: '#fafcff' }}>
                    <div className="container">
                         <div className="row justify-content-center">
                              <div className="col-md-5 justify-content-center align-items-center">
                                   <img src="https://bajratechnologies.com/web/image/34946/Software%20Monitoring%20and%20%20Analytics.png" alt="" className="fadeLeft" />
                              </div>
                              <div className="col-md-6 justify-content-center align-items-center">
                                   <p className="fs-1 lh-sm">Software Monitoring and Analytics</p>
                                   <p className="fs-6 lh-lg">We understand the critical importance of monitoring software performance, user interactions, and system health in today&apos;s digital landscape. To achieve this, we utilize a range of cutting-edge monitoring tools and platforms to collect real-time data, swiftly detect anomalies, and ensure the utmost reliability of our clients&apos; applications. Our advanced analytics capabilities offer valuable insights into user behavior, application usage trends, and performance bottlenecks. These insights drive data-centric decision-making, allowing us to proactively tackle issues, enhance user experiences, and elevate the overall quality of our software solutions. Through our vigilant approach, Bajra helps our clients maintain their competitive edge, reduce downtime, and consistently deliver exceptional digital experiences to their customers.</p>
                              </div>
                         </div>
                    </div>
