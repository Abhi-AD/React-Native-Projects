...
const ProcessSection = () => {
     return (
          <div>
               <section className="process pt-0 oe_img_bg oe_custom_bg" data-name="Process">
                    <div className="row">
                         <section className="text-center pt-7 anim_fadeinup fadeInUpFast fadeInUp_process">
                         ...
                         <div className="container">
                              <section className="data align-items-center justify-content-center">
